...
namespace Compensable.Tests.CompensatorTests
{
    public class DoIfAsync : TestBase
    {
        ...
        public async Task CompensationFails()
        {
            ...
            AssertInternalCompensations(compensator, doIfHelper1);
        }
        ...
        public async Task CompensationWillFail()
        {
            ...
            AssertInternalCompensations(compensator, doIfHelper, tag);
        }
        ...
        public async Task ExecutionIsNull()
        {
            ...
            // assert
            Assert.Equal(ExpectedMessages.ValueConnotBeNull("execution"), exception.Message);
        ...
        public async Task TagIsNull()
        {
            ...
            AssertInternalCompensations(compensator, unusedTag, doIfHelper);
        }
        ...
        public async Task TestIsNull()
        {
            ...
            // assert
            Assert.Equal(ExpectedMessages.ValueConnotBeNull("test"), exception.Message);
